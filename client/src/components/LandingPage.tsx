...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <nav className="navbar">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-2xl font-extrabold gradient-text">SparkleWash</span>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative section pt-8 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 text-shadow-lg">
              <span className="gradient-text">Sparkle</span>
              <span className="text-gray-800">Wash</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, idx) => (
              <div key={idx} className="feature-card">
                <div className={`feature-icon bg-gradient-to-r ${service.color}`}>
                  {service.icon}
                </div>
            ...
            {howItWorks.map((step, idx) => (
              <div key={idx} className="relative">
                <div className="card text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mb-6 mx-auto animate-bounce-slow">
                    {idx + 1}
                  </div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">{step.step}</h4>
                  <p className="text-gray-600">{step.desc}</p>
                </div>
                {idx < howItWorks.length - 1 && (
                  <div className="hidden md:block absolute top-8 -right-4 w-8 h-8 text-blue-300">
      ...
      <section className="section bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold gradient-text mb-4">Why Choose SparkleWash?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {whyChooseUs.map((reason, idx) => (
              <div key={idx} className="flex items-start gap-4 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl">
                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <span className="text-lg text-gray-800 font-medium">{reason}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust SparkleWash for their vehicle cleaning needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              className="bg-white text-blue-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              onClick={() => navigate('/register')}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-2xl font-bold">SparkleWash</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Premium Detailing</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Fleet Services</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>Email: info@sparklewash.com</li>
